  ...
  function renderSpot() {
    switch (spotPhase) {
      ...
      case "search by track":
        return (
          <SpotTrack setAlert={setAlert} showSpotDialog={showSpotDialog} />
        );
      case "search by artist":
        return (
          <SpotArtist setAlert={setAlert} showSpotDialog={showSpotDialog} />
        );
      case "search by weights":
        return (
          <SearchByWeights
            setAlert={setAlert}
            showSpotDialog={showSpotDialog}
          />
        );
      case "explanation":
