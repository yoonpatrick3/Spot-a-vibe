...
import ContinuousSlider from "../../../organisms/MySlider";
import { SongWeight } from "../../../organisms/MySlider";
...
export default function SearchByWeights({
  setAlert,
  showSpotDialog,
  ...
  function weightedSearch() {
    fetch(
      `${address}/apiWeights?d=${weights.Danceability}&v=${weights.Valence}&a=${weights.Acousticness}&e=${weights.Energy}&i=${weights.Instrumentalness}`
    )
      .then((response) => {
        return response.json();
      })
      .then((data) => {
        let track_array = data.similar_songs.map(
          (track: {
            img_link: string;
            title: string;
            artist_name: string;
  ...
  function renderByWeightPhase() {
    switch (weightPhase) {
      case WeightQuestionPhase.Initial:
        return (
          <>
            <DialogTitle id="stat-dialog">
              It's okay, just let me know know your vibe :)
            </DialogTitle>
            <Divider></Divider>
            <DialogContent>
              <DialogContentText>
                I'll ask you some questions and we'll give a recommendation
            ...
            <DialogActions>
              <Button
                onClick={() => {
                  setWeightPhase(WeightQuestionPhase.Danceability);
                }}
                color="primary"
              >
                Get Started
          ...
          <>
            ...
            <DialogContent>
              <DialogContentText>
                ...
                <ContinuousSlider
                  weightName="Danceability"
                  setWeight={setWeight}
                  min={0.2}
                  max={1.0}
                  defaultValue={weights.Danceability}
                ></ContinuousSlider>
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              <Button
                onClick={() => {
                  setWeightPhase(WeightQuestionPhase.Initial);
                }}
              >
                Back
              </Button>
              <Button
                onClick={() => {
                  setWeightPhase(WeightQuestionPhase.Valence);
                }}
                color="primary"
              >
                Next
      ...
      case WeightQuestionPhase.Valence:
        return (
          <>
            ...
            <DialogContent>
              <DialogContentText>
                Are you looking for a positive/happy song (high) or a sad/angry
                song (low)?
                <ContinuousSlider
                  weightName="Valence"
                  setWeight={setWeight}
            ...
            <DialogActions>
              ...
              <Button
                onClick={() => {
                  setWeightPhase(WeightQuestionPhase.Energy);
                }}
                color="primary"
              >
                Next
        ...
        return (
          <>
            ...
            <DialogActions>
              ...
              <Button
                onClick={() => {
                  setWeightPhase(WeightQuestionPhase.Instrumentalness);
                }}
                color="primary"
              >
                Next
      ...
      case WeightQuestionPhase.Instrumentalness:
        return (
          <>
            ...
            <DialogContent>
              <DialogContentText>
                Do you like more instrumental music, or in other words, do you
                like music with fewer words?
                <ContinuousSlider
                  weightName="Instrumentalness"
                  setWeight={setWeight}
                  min={0.0}
                  max={0.06}
                  defaultValue={weights.Instrumentalness}
                ></ContinuousSlider>
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              ...
              <Button
                onClick={() => {
                  setWeightPhase(WeightQuestionPhase.Acousticness);
                }}
                color="primary"
              >
                Next
      ...
      case WeightQuestionPhase.Acousticness:
        return (
          <>
            ...
            <DialogContent>
              <DialogContentText>
                How important do you value acoustic music ie. non electric
                music?
                <ContinuousSlider
                  weightName="Acousticness"
                  setWeight={setWeight}
                  max={0.4}
                  min={0.0}
                  defaultValue={weights.Acousticness}
                ></ContinuousSlider>
              </DialogContentText>
            </DialogContent>
            <DialogActions>
