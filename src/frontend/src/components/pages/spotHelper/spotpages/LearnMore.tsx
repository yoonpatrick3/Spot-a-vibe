import { useStyles } from "../../../atoms/Intro";
    ...
    <>
      ...
      <DialogContent>
        <DialogContentText className="spot-learn-more">
          <p>
            This project was made at HackBeanpot 2021 using the Spotify API. It
            is a flask and MySQL backend that serves a React SPA. It is served
            using Gunicorn and the Heroku platform.
          </p>
          <div>
            <Divider />
          </div>
          <div className="spot-bios" id="patrick">
            ...
            <p>
              This project's brain was created by Patrick Yoon. His algorithm is
              what drives our recommendations! Patrick contributed greatly to
              the project's ideation.
            </p>
          </div>
          ...
          <div className="spot-bios" id="saahil">
            ...
            <p>
              Saahil helped design our database representation and oversaw its
              initialization. Saahil was indispensable in the routes, API calls,
              and team energy. :)
            </p>
          </div>
          <div className="spot-bios" id="cheng">
            ...
            <p>
              Cheng built the search form UI on the homepage, front and center!
              He also contributed greatly to project ideation with the idea to
              search by weights.
            </p>
          </div>
        </DialogContentText>
      ...
      <DialogActions>
        <Button
          onClick={() => {
            setPhase(SpotPhase.LearnEvenMore);
          }}
        >
          Learn Even More
        </Button>
