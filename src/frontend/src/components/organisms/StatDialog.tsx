      ...
      <List>
        <ListItem divider={true}>
          {isTrack ? (
            ...
            <ListItemText
              primary="Every track can be broken down into a set of audio features and this decomposition is what drives our algorithm.
        ...
        <ListItem divider={true}>
          <ListItemText
            ...
            secondary="Danceability describes how suitable a track is for dancing based on a combination of 
        ...
        <ListItem divider={true}>
          <ListItemText
            primary="Valence"
            secondary="A measure to describe the musical positiveness conveyed by a track. 
        ...
        <ListItem divider={true}>
          <ListItemText
            ...
            secondary="A confidence measure of whether the track is acoustic, meaning whether the track uses non-electric instruments."
          />
        </ListItem>
        <ListItem divider={true}>
          <ListItemText
            primary="Energy"
            secondary="Energy is a measure to represent a perceptual measure of intensity and activity. 
        ...
        <ListItem divider={true}>
          <ListItemText
            ...
            secondary="Predicts whether a track contains no vocals. “Ooh” and “aah” sounds are treated as 
