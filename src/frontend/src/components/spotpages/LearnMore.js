...
export default function LearnMore(props) {
    ...
    return (
        <>
                    ...
                    <DialogContent>
                        <DialogContentText className="spot-learn-more">
                            ...
                            <div className="spot-bios" id="david">
                                ...
                                <p>Hi, I'm David! This project was unfinished for the longest time, so I hope you enjoy the finished product!
                    ...
                    <DialogActions>
                        <Button onClick={() => { props.setPhase('explanation') }} color="disabled">
                            Learn Even More
                        </Button>
